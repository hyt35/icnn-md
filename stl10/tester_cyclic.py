# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 14:30:59 2022
...
#stl10_data = torchvision.datasets.STL10('./stl10', split='train', transform=torchvision.transforms.ToTensor(), folds=1, download=True)
...
icnn_fwd.load_state_dict(torch.load('checkpoints/cyclic/925fwd_small', map_location='cuda:0'))
icnn_bwd.load_state_dict(torch.load('checkpoints/cyclic/925bwd_small', map_location='cuda:0'))
...
for batch_, _ in test_dataloader:
    ...
    plt.title("Cyclic padding "+ str(noise_level*100) + "% noise")
