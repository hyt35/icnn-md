...
checkpoint_path = '/local/scratch/public/hyt35/ICNN-MD/ICNN-STL10/checkpoints/Apr27_denoising/'
logging.basicConfig(filename=datetime.now().strftime('logs/%d-%m_%H:%M-denoise.log'), filemode='w', format='%(name)s - %(levelname)s - %(message)s', level=logging.DEBUG)
