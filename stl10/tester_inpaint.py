...
if __name__ == '__main__': 
    ...
    for idx, (batch_, _) in enumerate(test_dataloader):
        ...
        avgss = torch.min(icnn_couple.stepsize)
        ...
        plt.ylim((min_mdloss/5,max_mdloss*10))
        #plt.ylim((min_mdloss/5,min_mdloss*10))
        
        break
    plt.savefig('inpaint_log')
    print(icnn_couple.stepsize)
#ss: [0.1, 0.0642, 0.0442,0.0281,0.0203,0.0144,0.0107,0.0076,0.0049,0.0024]