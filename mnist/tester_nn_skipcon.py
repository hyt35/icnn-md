...
checkpoint_path = '/local/scratch/public/hyt35/ICNN-MD/ICNN-ARTIFICIAL/checkpoints/nn_skip/3200'
...
#ax_loss.legend(loc='upper right', fontsize='x-small')
#ax_prob.legend(loc='lower right', fontsize='x-small')
fig_loss.savefig('figs/nn_skipcon')
fig_prob.savefig('figs/nn_skipcon_acc')
fig_loss.savefig('figs/nn_skipcon.svg')
fig_prob.savefig('figs/nn_skipcon_acc.svg')
