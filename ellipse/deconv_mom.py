...
IMPL = 'astra_cuda'
device = 'cuda:0'
workdir = "/local/scratch/public/hyt35/icnn-md-mom/ellipse/deconv_mom"
...
logging.basicConfig(filename=os.path.join(workdir,datetime.now().strftime("%d-%m_%H-%M-deconv_mom.log")), filemode='w', format='%(name)s - %(levelname)s - %(message)s', level=logging.DEBUG)
