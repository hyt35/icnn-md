...
checkpoint_path = '/local/scratch/public/hyt35/ICNN-MD/ICNN-ARTIFICIAL/checkpoints/svm/3000'
...
ax_loss.set_position([box.x0, box.y0, box.width * 0.9, box.height])
...
ax_prob.set_position([box.x0-box.width*0.1, box.y0, box.width * 0.9, box.height])

legend1 = ax_prob.legend(handles=[md_adap_patch,md_patch,gd_adap_patch,adam_adap_patch], bbox_to_anchor=(1.02, 0.7),
                         loc='center left', borderaxespad=0.)
ax_prob.legend(handles=[_mrkempty, _mrk1,_mrk2,_mrk3,_mrk4,_mrk5], bbox_to_anchor=(1.02,0.3),
                         loc='center left', borderaxespad=0.)
...
# fig_loss.savefig('figs/nn.pdf')
# fig_prob.savefig('figs/nn_acc.pdf')

fig.savefig('figs/svm_comb',bbox_inches='tight')
fig.savefig('figs/svm_comb.pdf',bbox_inches='tight')
fig.savefig('figs/svm_comb.svg',bbox_inches='tight')