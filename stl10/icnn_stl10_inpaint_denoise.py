...
device = 'cuda'
checkpoint_path = '/local/scratch/public/hyt35/ICNN-MD/ICNN-STL10/checkpoints/Apr27_inpainting_denoising/'
logging.basicConfig(filename=datetime.now().strftime('logs/%d-%m_%H:%M-inpainting-denoising.log'), filemode='w', format='%(name)s - %(levelname)s - %(message)s', level=logging.DEBUG)
