...
checkpoint_path = 'checkpoints/lsq_mdlsq_alt/'
...
if __name__ == "__main__":
    if args.train:
        logging.basicConfig(filename=datetime.now().strftime('logs/%d-%m_%H%M-lsq-mdlsq-alt.log'), filemode='w', format='%(name)s - %(levelname)s - %(message)s', level=logging.DEBUG)
        ...
        foofig.savefig(fig_dir+'lsq_iters.svg')
